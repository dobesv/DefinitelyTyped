...
declare namespace IORedis {
    ...
    interface Commands {
        ...
        set(key: KeyType, value: ValueType, callback: Callback<Ok | null>): void;
        set(key: KeyType, value: ValueType, setMode: string | any[], callback: Callback<Ok | null>): void;
        set(key: KeyType, value: ValueType, expiryMode: string, time: number | string, callback: Callback<Ok | null>): void;
        set(
            key: KeyType,
            value: ValueType,
            expiryMode: string,
